        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 id="previous-work-heading" className="text-4xl md:text-5xl font-light mb-4 bg-gradient-to-r from-white to-green-400 bg-clip-text text-transparent">
              Impressive Ad Spend Management
            </h2>
            <p className="text-xl text-gray-400 font-light max-w-3xl mx-auto">
              Real campaign dashboards showcasing successful ad spend management and performance optimization across multiple platforms
            </p>
          </motion.div>
